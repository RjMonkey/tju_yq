...
<head>
    ...
    <script src="/yq/Public/statics/layer/layer.js"></script>
                ...
                <div id="page-content">
                    ...
                    <div class="panel widget">
                        <div class="widget-header bg-purple">
                            <img class="widget-bg img-responsive" src="/yq/Public/statics/img/thumbs/img3.jpg" alt="Image">
                        </div>
                        <div class="widget-body text-center">
                            <img alt="Profile Picture" class="widget-img img-circle img-border-light" src="/yq/Public/statics/img/profile-photos/9.png">
                                    ...
                                    <div class="list-group bg-trans">
                                        <a href="#" class="list-group-item">
                                            <div class="media-left pos-rel">
                                                <img class="img-circle img-xs" src="/yq/Public/statics/img/profile-photos/2.png" alt="Profile Picture">
                                        ...
                                        <a href="#" class="list-group-item">
                                            <div class="media-left pos-rel">
                                                <img class="img-circle img-xs" src="/yq/Public/statics/img/profile-photos/7.png" alt="Profile Picture">
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <a href="#" class="list-group-item">
                                            <div class="media-left pos-rel">
                                                <img class="img-circle img-xs" src="/yq/Public/statics/img/profile-photos/1.png" alt="Profile Picture">
                                        ...
                                        <a href="#" class="list-group-item">
                                            <div class="media-left pos-rel">
                                                <img class="img-circle img-xs" src="/yq/Public/statics/img/profile-photos/4.png" alt="Profile Picture">
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <a href="#" class="list-group-item">
                                            <div class="media-left pos-rel">
                                                <img class="img-circle img-xs" src="/yq/Public/statics/img/profile-photos/8.png" alt="Profile Picture">
                                        ...
                                        <a href="#" class="list-group-item">
                                            <div class="media-left pos-rel">
                                                <img class="img-circle img-xs" src="/yq/Public/statics/img/profile-photos/9.png" alt="Profile Picture">
